  ...
  const CH = {
    pcyes: {
      ...
      figuras: {
        ...
        ckCarregado: { legenda: "V1, fully loaded: the card brand strip takes a whole band and pushes the summary out of the first fold." },
        ckLento: { legenda: "The same screen on a slow connection: the strip never arrives and leaves dead space in the most expensive spot on the page." },
        ckV12: { legenda: "V1.2: components repositioned. The fold got shorter, the dead space is gone and the payment methods show up right away, on desktop and on mobile." },
      ...
      decisoes: [
        ...
        { d: "Product copy generated from the SKU", fig: "sku", figExtra: "skuFila",
      ...
      modulos: [
        ...
        { k: "A fix before the V2", t: "The checkout got better without waiting for the redesign",
          p: ["The V2 has a release date, and the V1 checkout was losing sales along the way. Instead of waiting, I proposed a small fix to the version already running.",
              "The diagnosis came from looking at the same screen in two states. Fully loaded, the card brand strip ate height and pushed the summary below the fold. On a slow connection that strip simply never arrived, leaving dead space exactly where the buying decision happens.",
              "The V1.2 repositioned the components: the fold got shorter, the idle space is gone and the payment methods now show up right away, on desktop and on mobile. It is the same idea the V2 takes further, delivered months earlier."],
