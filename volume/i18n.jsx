    ...
    pcyes: {
      ...
      problema: { t: "Three tolls to buy a mouse",
        p: ["In the recordings the same scene kept repeating. Someone found the product inside the campaign, clicked, waited for the page to open, and only there was there a buy button. Neither the storefront, nor the home, nor the category pages let you add to the cart, so every purchase cost clicks that didn't need to exist.",
            "Whoever got through that still stopped at the end. Checkout concentrated the drop-off and no report said why, and that is where I put my chips: if people vanish on the last screen, the problem lives on the last screen.",
            "Added up, the site charged three tolls to someone who only wanted a mouse. Find the product inside the campaign, open its page to be able to add it to the cart, and guess in the dark whether they could pay the way they wanted."] },
      painel: {
      ...
      funil: {
        ...
        nota: "I lost that bet here. Whoever reaches checkout buys at 25%, one in four, so the last screen was never the main hole, before or after the fix I had just shipped to it. The hole sat one step earlier, between looking at a product and putting it in the cart, which was exactly the step I wasn't looking at. The V2 was redesigned out of that correction. Whole quarter, event by event, not a sample.",
      },
      ...
      sistema: {
        ...
        p: ["Forty screens drawn by hand become forty repeated decisions about spacing, state and color. Before drawing, I built the vocabulary: 239 tokens in the theme file, 69 components built on top of them.",
            "What changes is the address of the color. In the V1, the grey for secondary text was a hex written on the spot, different on every screen. In the V2 it has a name and a job: ink-muted is the role \u201csecondary text\u201d, and when the theme flips it flips on its own."],
        escada: {
        ...
        motion: {
          ...
          dur: "300ms",
          p: "It leaves fast and arrives slowly, which is how something with weight comes to a stop. The alternative is every component picking its own, and then the whole site looks like it was made by different people. One curve and one default duration for everything that moves.",
      ...
      aprendi: { p: ["Brand value and conversion entered the project as opposite choices, and they aren't. The brand could show up as much as it liked. What got in the way was the brand taking the product's place in the page hierarchy.",
