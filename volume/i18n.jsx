  ...
  const CH = {
    pcyes: {
      ...
      problema: { t: "Nice to look at, hard to buy from",
        p: ["The first version was built on top of the brand, with video, animation and a lot of institutional presence.",
            "People weren't reaching checkout, and the reason sat earlier: buying anything meant opening the product page, because neither the storefront, nor the home, nor the category pages let you add to the cart. Every purchase cost clicks that didn't need to exist.",
      ...
      busca: {
        ...
        p: ["I went to test what search answered. It was the store's main path: 71,416 sessions used search in the quarter, 43% of the total, more than the 50,399 that opened a product page.",
            ...
            "And that path, the most used in the whole store, was the one returning a mousepad to anyone looking for a mouse, and nothing to anyone typing mause."],
      ...
      sistema: {
        ...
        p: ["Forty screens drawn by hand become forty repeated decisions about spacing, state and color. Before drawing, I built the vocabulary: 239 tokens in the theme file, 69 components built on top of them.",
            "What changes isn't the amount of color, it's its address. In the V1, the grey for secondary text was a hex written on the spot, different on every screen; in the V2 it has a name and a job, and ink-muted became the role \u201csecondary text\u201d instead of just a grey. When the theme flips, it flips on its own."],
        escada: {
