  ...
  return (
    <div className="sum-zone tem-fundo">
      ...
      <section className="shell sum-head" id="sumario">
        ...
        <p className="sh-sub">
          {t("Cada capítulo é um produto real: o problema, o que eu decidi e o que mudou depois. O primeiro é o mais longo, e é onde tem mais dado.",
             "Each chapter is a real product: the problem, what I decided, and what changed after. The first one is the longest, and it's where the data is.")}
        </p>
        ...
        <div className="qs-left">
          ...
          <p className="qs-bio qs-bio-2">
            {t("Leio mangá desde criança, e é de lá que vem o jeito de organizar este portfólio: capítulo, página, respiro. Trabalho perto de quem usa o produto, e mudo de direção quando o dado pede.",
               "I've read manga since I was a kid, and that's where the shape of this portfolio comes from: chapters, pages, breathing room. I work close to the people who use the product, and I change direction when the data asks for it.")}
          </p>
